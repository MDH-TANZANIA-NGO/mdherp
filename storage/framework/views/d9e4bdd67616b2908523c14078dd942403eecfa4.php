...
<body>
<?php if(access()->user()->designation): ?>
    ...
    <div class="content">
        ...
        <div class="container">
            ...
            <table class="table card-table table-vcenter text-nowrap">
                ...
                <tbody>
                <tr>
                    <td>OUR REF | <?php echo e($job_offer->number); ?></td>
                    <td><div class="float-right">  <?php echo e(\Carbon\Carbon::now()); ?></div></td>
                </tr>
                <tr>

                    <td> <h4 class="float-left"><strong><?php echo e($job_offer->interviewApplicant->applicant->full_name); ?></strong>,</h4></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><p class="" style="margin-left: 30%"><b><u>RE: OFFER OF EMPLOYMENT TO THE POST <?php echo e(strtoupper($job_offer->interviewApplicant->interviews->jobRequisition->designation->full_title)); ?></u></b></p><br><p>On behalf of Management and Development for Health, I am pleased to inform you that you have been appointed as <b><?php echo e($job_offer->interviewApplicant->interviews->jobRequisition->designation->full_title); ?></b> , on contract basis.</p></td>
                </tr>
                <tr>
                    <td><p>The following is a brief summary of the terms and conditions of service attached to your appointment:</p></td>
                </tr>
                <tr>


                    <td><b>Salary</b><br><p>Your Basic Salary will be <?php echo e(currency_converter($job_offer->salary, 'TSH')); ?> USD per month, from which deduction of PAYE will be made as stipulated by law.</p></td>
                </tr>
...
<?php /**PATH /Users/elinipendomziray/Sites/mdherp/resources/views/printables/humanResource/hireRequisition/jobOffer/job_offer.blade.php ENDPATH**/ ?>