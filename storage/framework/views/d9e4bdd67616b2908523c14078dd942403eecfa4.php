...
<?php if(access()->user()->designation): ?>
    <div class="signature">
        <div class="print-info">Printed By :<b><?php echo e(access()->user()->full_name_formatted); ?></b><br>
            <?php echo e(access()->user()->title); ?><br>
...
<?php endif; ?>
    <div class="content">
        ...
        <div class="header">
            ...
            <div class="document-title bold-text">JOB OFFER | <?php echo e($job_offer->number); ?></div>
