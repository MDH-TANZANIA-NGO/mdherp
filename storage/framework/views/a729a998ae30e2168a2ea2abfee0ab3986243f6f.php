...
<div class="card">
<form id="application-form" action="<?php echo e(route('job_shortlister.store')); ?>" method="POST">
<?php echo csrf_field(); ?>
    <div class="card-header">
        <h3 class="card-title">List of Current Jobs</h3>
        <div class="card-options ">
            <?php echo Form::submit('Click here to add shortlisters',['class' => 'btn btn-primary', 'id' => 'submit_form']); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mdherp\resources\views/humanResource/hireRequisition/job/applications.blade.php ENDPATH**/ ?>