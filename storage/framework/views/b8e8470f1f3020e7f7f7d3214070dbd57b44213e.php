    ...
    <div class="horizontal-mainwrapper clearfix">
        <nav class="horizontalMenu clearfix">
            <ul class="horizontalMenu-list">
                <li aria-haspopup="true"><a href="#" class="sub-icon "><i class="fe fe-monitor hor-icon"></i> Dashboard <i class="fa fa-angle-down horizontal-icon"></i></a>
                    <ul class="sub-menu">
                ...
                <li aria-haspopup="true"><a href="#" class="sub-icon"><i class="fe fe-layers hor-icon"></i> Apps <i class="fa fa-angle-down horizontal-icon"></i></a>
                    <ul class="sub-menu">
                ...
                <li aria-haspopup="true"><a href="#" class="sub-icon"><i class="fe fe-compass"></i> Advanced UI </a>
                    <ul class="sub-menu">
                ...
                <li aria-haspopup="true"><a href="#" class="sub-icon"><i class="fe fe-package"></i> Elements  <i class="fa fa-angle-down horizontal-icon"></i></a>
                ...
                <li aria-haspopup="true"><a href="#" class="sub-icon active"><i class="fe fe-box"></i> Pages <i class="fa fa-angle-down horizontal-icon"></i></a>
                    <ul class="sub-menu">
                ...
                <li aria-haspopup="true"><a href="#" class="sub-icon"><i class="fe fe-award"></i> Icons <i class="fa fa-angle-down horizontal-icon"></i></a>
                    <ul class="sub-menu">
...
<?php /**PATH /Users/elinipendomziray/Sites/mdherp/resources/views/includes/navigation/horizontal.blade.php ENDPATH**/ ?>