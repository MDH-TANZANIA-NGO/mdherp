        ...
        <div class=" tab-menu-heading card-header" style="background-color: rgb(238, 241, 248)">
            <div class="tabs-menu1 ">
                ...
                <ul class="nav panel-tabs">
                    <li class=""><a href="#processing" class="active" data-toggle="tab">On Process <span class="badge badge-warning"><?php echo e($induction_access->getProcessing()->count()); ?></span></a></li>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#access_processing").DataTable({
                ...
                "responsive": true,
                "autoWidth": false,
                ajax: '<?php echo e(route('induction_schedule.datatable.processing')); ?>',
                columns: [
