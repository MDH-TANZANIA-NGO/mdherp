                ...
                <table class="table table-bordered table-stripped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if(!isset($show)): ?> 
                                 <input type="radio" name="technical_staff" value="<?php echo e($panelist->id); ?>"> 
                                <?php endif; ?>
                                <?php if(isset($show) && $panelist->technical_staff == 1): ?> 
...
</div><?php /**PATH /Users/william/Code/mdherp/resources/views/HumanResource/interview/panelist/show.blade.php ENDPATH**/ ?>