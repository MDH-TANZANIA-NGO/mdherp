        ...
        <div class=" tab-menu-heading card-header" style="background-color: rgb(238, 241, 248)">
            <div class="tabs-menu1 ">
                ...
                <ul class="nav panel-tabs">
                    ...
                    <li><a href="#wait_for_verification" data-toggle="tab" class="">Waiting For Verification <span class="badge badge-info"><?php echo e($wait_verification_count); ?></span></a></li>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#access_wait_for_verification").DataTable({
                ...
                "responsive": true,
                "autoWidth": false,
                ajax: "<?php echo e(route('hr.pr.datatable.access.wait_for_evaluation')); ?>",
                columns: [
                    { data: 'DT_RowIndex', name: 'DT_RowIndex','bSortable': false, 'aTargets': [0], 'bSearchable': false },
                    { data: 'number', name: 'pr_reports.number', searchable: true},
                    { data: 'pr_type_title', name: 'pr_types.title', searchable: true},
