        ...
        <div class=" tab-menu-heading card-header" style="background-color: rgb(238, 241, 248)">
            <div class="tabs-menu1 ">
                ...
                <ul class="nav panel-tabs">
                    <li><a href="#wait_for_interview_questions" data-toggle="tab" class="active">Waiting For Interview Questions <span class="badge badge-info"><?php echo e($wait_interview_question_count); ?></span></a></li>
                    <li><a href="#wait_for_interview_report" data-toggle="tab" class="">Waiting For Interview Report <span class="badge badge-info"><?php echo e($wait_interview_report_count); ?></span></a></li>
                    <li><a href="#saved" data-toggle="tab" class="">Saved <span class="badge badge-default"><?php echo e($saved_count); ?></span> </a></li>
                    <li><a href="#approved" data-toggle="tab" class="">Completed <span class="badge badge-success"><?php echo e($approved_count); ?></span></a></li>
                </ul>
            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#access_wait_for_interview_report").DataTable({
                ...
                "responsive": true,
                "autoWidth": false,
                ajax: "<?php echo e(route('interview.datatable.access.wait_for_interview_report')); ?>",
                columns: [
                    { data: 'DT_RowIndex', name: 'DT_RowIndex','bSortable': false, 'aTargets': [0], 'bSearchable': false },
                    { data: 'number', name: 'pr_reports.number', searchable: true},
                    { data: 'job_title', name: '', searchable: true},
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/william/Code/mdherp/resources/views/HumanResource/Interview/datatables/access.blade.php ENDPATH**/ ?>