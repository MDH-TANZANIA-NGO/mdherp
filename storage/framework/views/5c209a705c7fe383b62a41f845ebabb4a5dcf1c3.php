    ...
    <div class="col-4 col-sm-4 col-lg-3">
        <a href="<?php echo e(route('job_offer.index')); ?>">
            <div class="card">
                <div class="card-body text-center">
                    <div class="h2 m-0"><i class="fa fas fa-ad"></i></div>
                    <div class="text-muted mb-0">New Recruit</div>
                </div>
            </div>
        </a>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/frank/Documents/Projects/mdherp2/resources/views/humanResource/JobManagement/index.blade.php ENDPATH**/ ?>