                   ...
                   <div class="row" >
                       ...
                       <div class="col-md-4">
                           <div class="form-group">
                               ...
                               {!! Form::select('designation', ['Officer'=>'Officer','Manager'=>'Manager', 'Assistance'=>'Assistance','Advisor'=>'Advisor', 'Director'=>'Director'], null, ['class' =>'form-control select2 custom-select', 'placeholder' => __('label.select') , 'aria-describedby' => '', 'required']) !!}
