        ...
        <div class=" tab-menu-heading card-header" style="background-color: rgb(238, 241, 248)">
            <div class="tabs-menu1 ">
                ...
                <ul class="nav panel-tabs">
                    <li class=""><a href="#processing" class="active" data-toggle="tab">On Process <span class="badge badge-warning">{{ $leaves->getSubmittedLeaves()->count() }}</span></a></li>
                    <li><a href="#rejected" data-toggle="tab" class="">Returned for Modification <span class="badge badge-danger">{{ $leaves->getRejectedLeaves()->count() }}</span></a></li>
                    <li><a href="#approved" data-toggle="tab" class="">Approved <span class="badge badge-success">{{ $leaves->getApprovedLeaves()->count() }}</span></a></li>
                </ul>
            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#access_processing").DataTable({
                ...
                "responsive": true,
                "autoWidth": false,
                ajax: '{{ route('leave_report.submitted') }}',
                columns: [
            ...
            $("#access_rejected").DataTable({
                ...
                "responsive": true,
                "autoWidth": false,
                ajax: '{{ route('leave_report.rejected') }}',
                columns: [
                    { data: 'DT_RowIndex', name: 'DT_RowIndex','bSortable': false, 'aTargets': [0], 'bSearchable': false },
                    { data: 'fullname', name: 'users.fullname', searchable: true},
                    { data: 'type_name', name: 'leave_types.name', searchable: true},
            ...
            $("#access_approved").DataTable({
                ...
                "responsive": true,
                "autoWidth": false,
                ajax: '{{ route('leave_report.approved') }}',
                columns: [
                    { data: 'DT_RowIndex', name: 'DT_RowIndex','bSortable': false, 'aTargets': [0], 'bSearchable': false },
                    { data: 'fullname', name: 'users.fullname', searchable: true},
                    { data: 'type_name', name: 'leave_types.name', searchable: true},
