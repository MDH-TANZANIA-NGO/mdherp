    ...
    <script>
        $(document).ready(function () {
            ...
            $("#access_processing").DataTable({
                ...
                "responsive": true,
                "autoWidth": false,
                ajax: '{{ route('financial-report.datatable.access.processing') }}',
                columns: [
                    { data: 'DT_RowIndex', name: 'DT_RowIndex','bSortable': false, 'aTargets': [0], 'bSearchable': false },
                    { data: 'number', name: 'payments.number', searchable: true},
                    { data: 'requested_amount', name: 'payments.requested_amount', searchable: true},
            ...
            $("#access_approved").DataTable({
                ...
                "responsive": true,
                "autoWidth": false,
                ajax: '{{ route('financial-report.datatable.access.approved') }}',
                columns: [
                    { data: 'DT_RowIndex', name: 'DT_RowIndex','bSortable': false, 'aTargets': [0], 'bSearchable': false },
                    { data: 'number', name: 'payments.number', searchable: true},
                    { data: 'requested_amount', name: 'payments.requested_amount', searchable: true},
