                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::textarea('background_info',null,['class' => 'form-control','required']) !!}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::textarea('plan',null,['class' => 'form-control ','required']) !!}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::textarea('objectives',null,['class' => 'form-control ','required']) !!}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::textarea('methodology',null,['class' => 'form-control','required']) !!}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::textarea('achievement',null,['class' => 'form-control ','required']) !!}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::textarea('challenges',null,['class' => 'form-control ','required']) !!}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::textarea('recommendations',null,['class' => 'form-control ','required']) !!}
