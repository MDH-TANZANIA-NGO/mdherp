        ...
        <div class=" tab-menu-heading card-header" style="background-color: rgb(238, 241, 248)">
            ...
            <div class="page-rightheader ml-auto d-lg-flex d-non pull-right">
                <div class="btn-group mb-0">
                    <a href="{{ route('listing.create') }}"> <i class="fa fa-plus mr-2"></i>Create Request</a>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#access_rejected").DataTable({
                ...
                "responsive": true,
                "autoWidth": false,
                ajax: '{{ route('listing.datatable.access.rejected') }}',
                columns: [
                    { data: 'DT_RowIndex', name: 'DT_RowIndex','bSortable': false, 'aTargets': [0], 'bSearchable': false },
                    { data: 'title', name: 'listings.title', searchable: true},
                    { data: 'region', name: 'regions.name', searchable: true},
            ...
            $("#access_approved").DataTable({
                ...
                "responsive": true,
                "autoWidth": false,
                ajax: '{{ route('listing.datatable.access.approved') }}',
                columns: [
                    { data: 'DT_RowIndex', name: 'DT_RowIndex','bSortable': false, 'aTargets': [0], 'bSearchable': false },
                    { data: 'title', name: 'listings.title', searchable: true},
                    { data: 'region', name: 'regions.name', searchable: true},
