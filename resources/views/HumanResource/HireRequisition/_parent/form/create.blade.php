			...
			<div class="tab-pane active" id="processing">
				...
				<div class="tab-pane " id="returned">
					<div class="card-body">
							...
							<div class="col-10">
								...
								<select name="education_level" id="select-region"  style="width: 100%" class="form-control custom-select select2-show-search" data-placeholder="Education Level">
									...
									@foreach($education_levels as $education_level)
										<option value="{{$tool->id}}">{{$education_level->name}}</option>
									@endforeach
								</select>
							</div>
							@error('practical_experience')
						...
						<div class="row mt-2">
							<div class="col-10">
								<label class="form-label"> Years Of Experince </label>
								<div class="d-flex flex-row">
									<input type="number" class="form-control" name="experience_years" placeholder="Years of experience" required>
									<select class="form-control ml-2" name="sign" data-placeholder="Select filter">
										<option	value=">"> > Greater than Years of experience</option>
										<option	value="<"> < Less than Years of experience</option>
										<option	value=">="> >= Greater or Equal to Years of Experience</option>
										<option	value="<="> <= Less or Equal to Years of Experience</option>
										<option value="NIL"> Not Applicable </option>
									</select>
								</div>
							</div>
							<div class="col-2">
								<!-- <span class="d-flex flex-row justify-content-center align-items-baseline">
								  <input type="checkbox" name="is_required_years_of_experience"> <span> required * </span> 
								</span> -->
							</div>
							@error('practical_experience')
							<span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong> </span>
						...
						<div class="row mt-2">
							<div class="col-10">
								...
								<input type="text" class="form-control" name="age" placeholder="Age reguired" required>	 
							</div>
							<!-- <div class="col-2">
								<span class="d-flex flex-row justify-content-center align-items-baseline">
									<input type="checkbox" name="is_required_education_field" > <span> required * </span>
								</span>
							</div> -->
							@error('practical_experience')
							<span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong> </span>
					...
					<div class="row mt-3">
						...
						<div class="col-6">
						<button type="button"  class="btn btn-inline-block btn-azure prev-step"> < Back </button>	
