					...
					<div class="col-lg-12 col-md-12">
						...
						<div class="row mt-2">
							...
							<div class="col-6">
								...
								<textarea class="form-control" name="special_employment_condition" rows="2" placeholder="Explain any Special Employment Condition" required> {{ $hireRequisitionJobs->special_employment_condition }}</textarea>
							</div>
