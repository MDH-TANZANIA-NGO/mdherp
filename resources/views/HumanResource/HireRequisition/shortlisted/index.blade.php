    ...
    <script>
        $(document).ready(function () {
            $("#access_processing").DataTable({
                ...
                "responsive": true,
                "autoWidth": false,
                ajax: "{{ route('job_applicant_request.datatable.processing') }}",
                columns: [
            ...
            $("#access_returned_for_modification").DataTable({
                ...
                "responsive": true,
                "autoWidth": false,
                ajax: "{{ route('job_applicant_request.datatable.return_for_modification') }}",
                columns: [
                    { data: 'DT_RowIndex', name: 'DT_RowIndex','bSortable': false, 'aTargets': [0], 'bSearchable': false },
                    { data: 'number', name: 'pr_reports.number', searchable: true},
                    { data: 'number_of_jobs', name: 'number_of_jobs', searchable: false},
            ...
            $("#access_approved").DataTable({
                ...
                "responsive": true,
                "autoWidth": false,
                ajax: "{{ route('job_applicant_request.datatable.approved') }}",
                columns: [
                    { data: 'DT_RowIndex', name: 'DT_RowIndex','bSortable': false, 'aTargets': [0], 'bSearchable': false },
                    { data: 'number', name: 'pr_reports.number', searchable: true},
                    { data: 'number_of_jobs', name: 'number_of_jobs', searchable: false},
