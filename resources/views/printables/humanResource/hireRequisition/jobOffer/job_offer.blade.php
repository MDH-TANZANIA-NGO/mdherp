...
{{--            <div class="document-title bold-text">OUR REF | {{ $job_offer->number }}</div>--}}
        ...
        <div class="container">
            ...
            <table class="table card-table table-vcenter text-nowrap">
                ...
                <tbody>
                <tr>
                    <td>OUR REF | {{ $job_offer->number }}</td>
                    <td><div class="float-right">  {{ \Carbon\Carbon::now() }}</div></td>
                </tr>
                <tr>

                    <td> <h4 class="float-left"><strong>{{$job_offer->interviewApplicant->applicant->full_name}}</strong>,</h4></td>
                </tr>
{{--                <tr>--}}

{{--                    <td> <h4 class="float-left"><strong>{{$job_offer->interviewApplicant->interview->jobRequisition->locations->region->name}}</strong>,</h4></td>--}}

{{--                </tr>--}}
                <tr>

                    <td><p class="" style="margin-left: 30%"><b><u>RE: OFFER OF EMPLOYMENT TO THE POST {{strtoupper($job_offer->interviewApplicant->interviews->jobRequisition->designation->full_title)}}</u></b></p><br><p>On behalf of Management and Development for Health, I am pleased to inform you that you have been appointed as <b>{{$job_offer->interviewApplicant->interviews->jobRequisition->designation->full_title}}</b> , on contract basis.</p></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><b>Salary</b><br><p>Your Basic Salary will be {{currency_converter($job_offer->salary, 'TSH')}} USD per month, from which deduction of PAYE will be made as stipulated by law.</p></td>
                </tr>
            ...
            <div>{!! htmlspecialchars_decode($job_offer->details) !!}</div>
