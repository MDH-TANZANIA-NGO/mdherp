...
@if(access()->user()->designation)
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <div class="document-title bold-text">{{ strtoupper($requisition->typeCategory->title) }}</div>
        ...
        <div class="summary-info">
            <table width="100%">
                ...
                <tr>
                    <td class="bold-text fixed-width">REGION :</td> <td class="fixed-width text-left">{{ $requisition->user->region->name }}</td> <td class="bold-text fixed-width">REQUESTED AMOUNT :</td> <td class="fixed-width text-left">{{ $requisition->amount }} TZS</td>
                </tr>
                <tr>
