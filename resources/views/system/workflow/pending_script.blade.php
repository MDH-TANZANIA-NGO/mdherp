                ...
                $(nRow).click(function() {
                    switch(aData['module_group_id']) {
                        ...
                        case 12: /*Performance Review Report*/
                            window.open(base_url + "/interview/report/show/" + aData['resource_uuid'] ,'_self');
                            break;
                        case 14: /*Performance Review Report*/
                            window.open(base_url + "/job_offer/" + aData['resource_uuid']+ '/show','_self' );
                            break;
                        ...
                        case 15: /*Shortlisted Report*/
                            ...
                            break;
                        case 16: /*Shortlisted Report*/
                            window.open(base_url + "/activity_reports/" + aData['resource_uuid']+ '/show');
                            break;
                        default:
                            break;
                    }
