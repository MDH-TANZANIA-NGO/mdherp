...
use App\Http\Controllers\Web\HumanResource\PerformanceReview\Traits\Datatables\PrCompetenceKeyDatatables;
use App\Repositories\HumanResource\PerformanceReview\PrCompetenceKeyRepository;
use Illuminate\Http\Request;

class PrCompetenceKeyController extends Controller
{
    use PrCompetenceKeyDatatables;
