...
class CreateRequisitionTrainingKostsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('requisition_training_costs', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('requisition_id');
            $table->bigInteger('participant_uid');
    ...
    {
        Schema::dropIfExists('requisition_training_kosts');
    }
}
